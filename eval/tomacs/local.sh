...
leaderPID="216.47.142.63" # "192.168.1.157" #216.47.152.71"
...
make_pause()
{
    ...
    sleep 0.1
    ssh -i /home/.ssh/id_ecdsa "root@${leaderPID}" "kill -10 `(ssh -i /home/.ssh/id_ecdsa root@${leaderPID} cat /home/EmbVT/eval/tomacs/local.sh.pid)`"
}
